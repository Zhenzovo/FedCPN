...
def load_partition_data_mnist_custom(dataset, data_dir, partition_method, partition_alpha, client_num_in_total,
...
def load_partition_data_mnist_fast(dataset, data_dir, partition_method, partition_alpha, client_num_in_total,
                                   client_number, batch_size,
                                   train_path="./../../../data/MNIST/train",
                                   test_path="./../../../data/MNIST/test"):
    users, groups, train_data, test_data = read_data(train_path, test_path)
...
def load_mnist_data(datadir):
    ...
    # mnist_train_ds = MNIST_truncated(datadir, train=True, download=True)
    # mnist_test_ds = MNIST_truncated(datadir, train=False, download=True)
